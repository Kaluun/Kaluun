(function ($) {
 ...
 function thmOwlInit() {
    $('.thm-owl__carousel').each(function() {
        ...
        if (dataOptions && dataOptions !== 'undefined' && dataOptions.trim() !== '') {
            try {
                var customOptions = JSON.parse(dataOptions);
                options = $.extend(true, {}, options, customOptions);
            } catch (e) {
                console.warn('Erreur parsing data-options sur carousel:', e, dataOptions);
            }
        }
